export const siteContent = {
  brand: {
    name: "CRECE",
    tagline: "Consultoría financiera e inversiones",
  ...
  training: {
    ...
    details: [
      ...
      { label: "Horario", value: "5:30 p.m. a 8:30 p.m." },
      { label: "Modalidad", value: "Presencial" },
      { label: "Sesiones", value: "7 sesiones" }
    ],
    offer: {
      price: "$299",
      regularPrice: "",
  ...
  contact: {
    ...
    website: "www.crecepanama.com.pa",
    ctaImages: {
      desktop: "/images/sections/cta-desktop.webp",
      mobile: "/images/sections/cta-mobile.webp"
    }
  },
  footer: {
